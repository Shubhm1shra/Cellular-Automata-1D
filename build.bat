...
set DEPENDENT=TRUE
set DEPENDENCY1=AutomataCal.cpp
set DEPENDENCY2=CellularAutomaton.cpp
...
if /i %DEPENDENT%==TRUE (
    g++ -O3 %~dp0%DEPENDENCY1% %~dp0%DEPENDENCY2% -o %~dp0%OUTPUT_FILE% %~dp0%SOURCE_FILE% -I\"C:\\msys64\\mingw64\\include\" -L\"C:\\msys64\\mingw64\\lib\" -lsfml-graphics -lsfml-window -lsfml-system
) else (
